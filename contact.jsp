...
<tr>
    ...
    <td>
                <a href="../crud/updatall.jsp?type=contact&id=<%=rs.getInt("id")%>"class="btn btn-primary btn-sm">Update</a>
                <a href="../crud/deleteall.jsp?type=contact&id=<%=rs.getInt("id")%>"class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete?')">Delete</a>
            </td>
</tr>
<%
    }
